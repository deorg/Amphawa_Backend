...
namespace Amphawa.Constant
{
    public static class SqlCmd
    {
        ...
        public static class AMP021
        {
            ...
            public const string getById = "select dept_id, sect_id, sect_name where sect_id = :sect_id";
        ...
        {
            public const string getAll = "select job_id, job_date, job_desc, solution, dept_id, sect_id, device_no, created_by, created_time from amp100";
